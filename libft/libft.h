...
/*   Updated: 2024/06/05 20:11:49 by hkeles           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
extern  int         word_count(char const *s, register char c);
extern char         *ft_strmapi(char const *s, char (*f)(unsigned int, char));
extern char         *get_next_line(register int fd);
extern char         *get_next_line_bonus(register int fd);
/* ************************ [^] MALLOC FUNCTIONS [^] ************************ */
/* ************************* [v] FREE FUNCTIONS [v] ************************* */
extern void         *ft_free(void **ptr);
extern void         **ft_free_arr(void ***ptr);
/* ************************* [^] FREE FUNCTIONS [^] ************************* */
/* ************************ [v] PRINT FUNCTIONS [v] ************************* */
extern int          ft_putchar_fd(char c, register int fd);
extern int          ft_putstr_fd(char *s, register int fd);
...
void               ft_bubblesort(int *arr, register int size);
/* ************************* [^] SORT FUNCTIONS [^] ************************* */
#endif /* LIBFT_H */
